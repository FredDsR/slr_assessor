...
class TestCLI:
    ...
    def test_screen_command_basic(self, mock_write_csv, mock_usage_tracker,
    ...
    def test_screen_command_help(self):
    ...
    def test_compare_command_help(self, mock_read_evals, mock_compare):
    ...
    @patch('slr_assessor.cli.read_papers_from_csv')
    def test_estimate_command_help(self, mock_read_papers, mock_estimate):
...
class TestCLICommands:
    ...
    def test_screen_command_required_args(self):
    ...
    def test_compare_command_required_args(self):
    ...
    def test_estimate_command_required_args(self):
