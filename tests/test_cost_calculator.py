...
class TestPricingTable:
    """Test the pricing table constants."""
    ...
    def test_pricing_table_models(self):
...
class TestEstimateTokens:
    ...
    def test_estimate_tokens_gpt_model(self, mock_tiktoken):
    ...
    def test_estimate_tokens_non_gpt_model(self):
...
class TestCalculateCost:
    ...
    def test_calculate_cost_anthropic_model(self):
...
class TestEstimateScreeningCost:
    """Test the estimate_screening_cost function."""

    @patch("slr_assessor.utils.cost_calculator.format_assessment_prompt")
    @patch("slr_assessor.utils.cost_calculator.estimate_tokens")
    def test_estimate_screening_cost_basic(self, mock_estimate_tokens, mock_format_prompt):
    ...
    @patch("slr_assessor.utils.cost_calculator.format_assessment_prompt")
    @patch("slr_assessor.utils.cost_calculator.estimate_tokens")
    def test_estimate_screening_cost_unknown_model(self, mock_estimate_tokens, mock_format_prompt):
    ...
    @patch("slr_assessor.utils.cost_calculator.format_assessment_prompt")
    @patch("slr_assessor.utils.cost_calculator.estimate_tokens")
    def test_estimate_screening_cost_zero_papers(self, mock_estimate_tokens, mock_format_prompt):
    ...
    @patch("slr_assessor.utils.cost_calculator.format_assessment_prompt")
    @patch("slr_assessor.utils.cost_calculator.estimate_tokens")
    def test_estimate_screening_cost_large_batch(self, mock_estimate_tokens, mock_format_prompt):
...
class TestGetProviderModels:
    ...
    def test_get_unknown_provider_models(self):
...
class TestGetPricingInfo:
    """Test the get_pricing_info function."""
    ...
    def test_get_pricing_info_gemini(self):
